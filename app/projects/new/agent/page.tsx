...
import { getMe, AlexisApiError } from "@/lib/api-client";
...
export default function AgentPage() {
  ...
  useEffect(() => {
    ...
    getMe(apiKey)
      .then((me) => {
        setForcedAgentChoice(me.forced_agent_choice);
      })
      .catch(() => {
        setForcedAgentChoice(null);
      });
  }, []);
    ...
    <>
      ...
      <p className="mt-1 text-sm text-foreground-muted">
        {isByok
          ...
          : "L'agent et le modèle sont gérés par Alexis sur votre plan. Aucune configuration requise."}
      </p>

      <form onSubmit={handleSubmit} className="mt-8 space-y-5">
        {/* Blocs BYOK — visibles uniquement pour les plans avec requires_own_key */}
        {isByok && (
          <>
            {/* Agent choice */}
            <div>
