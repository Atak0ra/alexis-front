...
const PIPELINE_STAGES = [
  {
    key: "todo",
    label: "Todo",
    description: "Le ticket est créé dans Linear et attend d'être pris en charge par l'agent.",
    icon: (
  ...
  },
  {
    key: "livraison",
    label: "Livraison",
    description: "Une PR est ouverte, le ticket Linear est mis à jour. Prêt à review.",
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
const VALUE_PROPS = [
  {
    ...
    description: "Alexis se branche sur votre workflow Linear et GitHub/GitLab existant. Pas de nouvelle méthode à apprendre.",
    icon: (
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="mx-auto flex w-full max-w-7xl flex-col items-center px-6 pb-24 pt-20 text-center">
          ...
          <p className="mt-6 max-w-2xl text-lg text-foreground-muted">
            Alexis connecte vos tickets Linear à un agent de code. Du ticket à la PR mergée,
